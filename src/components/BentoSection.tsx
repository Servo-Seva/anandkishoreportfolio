    ...
    <section id="about" className="section-padding relative">
      <div className="container-main">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-2 group relative overflow-hidden rounded-3xl bg-secondary/30 border border-border/30 p-8 hover:border-border/60 transition-all duration-500">
          ...
          {/* Timezone card */}
          <div className="group relative overflow-hidden rounded-3xl bg-secondary/30 border border-border/30 p-8 hover:border-border/60 transition-all duration-500">
            <div className="flex items-start justify-between mb-6">
          ...
          {/* Experience card */}
          <div className="lg:col-span-2 group relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/10 to-accent/10 border border-border/30 p-8 hover:border-border/60 transition-all duration-500">
            <div className="flex items-start justify-between mb-6">
